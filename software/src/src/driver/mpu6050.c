...
{
    gimbal->accl_x = gimbal->accl_x_raw / 32767 * 9.8;
    gimbal->accl_y = gimbal->accl_y_raw / 32767 * 9.8;
    gimbal->accl_z = gimbal->accl_z_raw / 32767 * 9.8;

    gimbal->gyro_x = gimbal->gyro_x_raw / 32.75;
    gimbal->gyro_y = gimbal->gyro_y_raw / 32.75;
    gimbal->gyro_z = gimbal->gyro_z_raw / 32.75;
